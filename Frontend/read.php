...
// Kita hanya perlu mengambil Judul untuk ditampilkan di Header
...
<body class="flex flex-col h-screen">
    <div class="bg-gray-900 text-white p-3 flex justify-between items-center shadow-lg z-10">
        <div class="flex items-center gap-3">
            <a href="dashboard-user.php" class="text-gray-300 hover:text-white transition flex items-center gap-1">
    ...
    <div class="flex-1 bg-gray-100 relative">
        <!-- PERUBAHAN UTAMA: SRC iframe mengarah ke stream_file.php -->
